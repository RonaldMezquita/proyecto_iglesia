...
public class num2Letras {
    ...
    private static long parteEntera;
    private static int triUnidades;
    private static int triMiles;
    private static int triMillones;
    private static int triMilMillones;
    ...
    public static String cantidadConLetra(String s) {
        ...
        parteEntera = totalBigDecimal.toBigInteger().longValue();
        triUnidades = (int) ((parteEntera % 1000));
        triMiles = (int) ((parteEntera / 1000) % 1000);
        triMillones = (int) ((parteEntera / 1000000) % 1000);
        triMilMillones = (int) ((parteEntera / 1000000000) % 1000);
