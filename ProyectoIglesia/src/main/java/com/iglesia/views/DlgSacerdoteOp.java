 ...
 * @author Alexis
 */
public class DlgSacerdoteOp extends javax.swing.JDialog {
    ...
    public DlgSacerdoteOp(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.txtdui.setForeground(new java.awt.Color(255,255,255));
        this.txtdui.setBackground(new java.awt.Color(55,71,79));
        this.txtdui.setBorder(null);
//        this.txtdui.setBounds(620, 210, 90, 30);
        jPanel1.add(txtdui, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 240, 90, 30));

        txtnit = ProjectUtils.getCampoNit();
        txtnit.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        this.txtnit.setForeground(new java.awt.Color(255,255,255));
        this.txtnit.setBackground(new java.awt.Color(55,71,79));
        this.txtnit.setBorder(null);
        jPanel1.add(txtnit, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 290, 142, 30));
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(910, 495));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 125, -1, -1));
        ...
        jPanel1.add(txtnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 140, 260, 30));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Apellido");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 175, -1, -1));

        txtapellido.setBackground(new java.awt.Color(55, 71, 79));
        txtapellido.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtapellido.setForeground(new java.awt.Color(255, 255, 255));
        txtapellido.setBorder(null);
        txtapellido.setName("Apellido"); // NOI18N
        jPanel1.add(txtapellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 190, 260, 30));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Parroco");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 325, -1, -1));

        cbestado.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cbestado.setForeground(new java.awt.Color(255, 255, 255));
        cbestado.setText("Activo");
        jPanel1.add(cbestado, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 395, -1, -1));
        ...
        jPanel1.add(btnguardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 430, 130, 40));
        ...
        jPanel1.add(btncancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(755, 430, 130, 40));
        ...
        jPanel1.add(txtbuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 300, 30));
        ...
        jPanel1.add(jbsalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(879, 1, 30, 30));
        ...
        jLabel4.setText("DUI");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 225, -1, -1));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("NIT");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 275, -1, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Estado");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 375, -1, -1));

        cbParroco.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cbParroco.setForeground(new java.awt.Color(255, 255, 255));
        cbParroco.setText("Es Parroco");
        jPanel1.add(cbParroco, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 345, -1, -1));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/META-INF/images/icon/buscar.png"))); // NOI18N
        ...
        tbsacerdote.setFocusable(false);
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 550, 360));

        jSeparator2.setBackground(new java.awt.Color(102, 102, 102));
        jSeparator2.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 230, -1));

        jSeparator3.setBackground(new java.awt.Color(102, 102, 102));
        jSeparator3.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 170, 260, -1));

        jSeparator4.setBackground(new java.awt.Color(102, 102, 102));
        jSeparator4.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 220, 260, -1));

        jSeparator5.setBackground(new java.awt.Color(102, 102, 102));
        jSeparator5.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 270, 90, -1));

        jSeparator6.setBackground(new java.awt.Color(102, 102, 102));
        jSeparator6.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 320, 142, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 910, 495));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgSacerdoteOp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgSacerdoteOp dialog = new DlgSacerdoteOp(new javax.swing.JFrame(), true);
