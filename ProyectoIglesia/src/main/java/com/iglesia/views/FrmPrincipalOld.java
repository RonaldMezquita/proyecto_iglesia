 ...
 * @author remsf
 */
public class FrmPrincipalOld extends javax.swing.JFrame {

    /**
     * Creates new form PrincipalFrame
     */
    public FrmPrincipalOld() {
        initComponents();
...
//        obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPrincipalOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPrincipalOld().setVisible(true);
            }
        });
    }
